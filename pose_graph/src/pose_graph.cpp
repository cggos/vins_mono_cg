        ...
        if (cur_index != -1) {
            ...
            for (it = keyframelist.begin(); it != keyframelist.end(); it++) {
                ...
                for (int j = 1; j < 5; j++) {
                    if (i - j >= 0 && sequence_array[i] == sequence_array[i - j]) {
                        ...
                        ceres::CostFunction* cost_function = 
                            FourDOFError::Create(relative_t.x(), relative_t.y(), relative_t.z(), relative_yaw, euler_conncected.y(), euler_conncected.z());
                ...
                if ((*it)->has_loop) {
                    ...
                    ceres::CostFunction* cost_function = 
                        FourDOFWeightError::Create(relative_t.x(), relative_t.y(), relative_t.z(), relative_yaw, euler_conncected.y(), euler_conncected.z());
