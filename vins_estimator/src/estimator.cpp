        ...
        for (auto &it_per_frame : it_per_id.feature_per_frame) {
            ...
            if (ESTIMATE_TD) {
                ...
                problem.AddResidualBlock(
                    f_td, loss_function, 
                    para_Pose[imu_i], para_Pose[imu_j], para_Ex_Pose[0], para_Feature[feature_index], para_Td[0]);
                /*
    ...
    if (marginalization_flag == MARGIN_OLD) {
        ...
        if (last_marginalization_info) {
            ...
            auto *residual_block_info = new ResidualBlockInfo(
                marginalization_factor, nullptr, last_marginalization_parameter_blocks, drop_set);
